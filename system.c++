...
// void drawPlanet(int xCenter, int yCenter, int orbitRadius, float angle, int color, int size) {
...
//         drawPlanet(sunX, sunY, mercuryOrbit, mercuryAngle, LIGHTGRAY, 4);  // Mercury
//         drawPlanet(sunX, sunY, venusOrbit, venusAngle, LIGHTCYAN, 6);     // Venus
//         drawPlanet(sunX, sunY, earthOrbit, earthAngle, BLUE, 6);          // Earth
//         drawPlanet(sunX, sunY, marsOrbit, marsAngle, RED, 5);             // Mars
//         drawPlanet(sunX, sunY, jupiterOrbit, jupiterAngle, LIGHTRED, 10); // Jupiter
//         drawPlanet(sunX, sunY, saturnOrbit, saturnAngle, LIGHTRED, 9); // Saturn
//         drawPlanet(sunX, sunY, uranusOrbit, uranusAngle, LIGHTBLUE, 7);   // Uranus
//         drawPlanet(sunX, sunY, neptuneOrbit, neptuneAngle, LIGHTMAGENTA, 7); // Neptune
//         drawPlanet(sunX, sunY, plutoOrbit, plutoAngle, WHITE, 3);         // Pluto
